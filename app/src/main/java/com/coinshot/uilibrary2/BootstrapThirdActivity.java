...
import com.coinshot.uilibrary2.databinding.ActivityBootstrapThirdBinding;

public class BootstrapThirdActivity extends AppCompatActivity {
    ActivityBootstrapThirdBinding binding;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_bootstrap_third);

        final SharedPreferences pref = getSharedPreferences("prefBoot", MODE_PRIVATE);
